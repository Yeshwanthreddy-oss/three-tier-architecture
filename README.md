...
#### 1. Clone the repo
    git clone https://github.com/Yeshwanth-Reddy-Aleti/three-tier-architecture && cd three-tier-architecture
...
#### 2. Verify app.py webapp is running via Docker 
SSH onto one of the EC2 hosts and verify that the app.py docker container is running -
...
## Maintainer
This project is currently maintained by Yeshwanth Reddy Aleti, a Network Engineer with over 4 years of experience in designing and supporting enterprise network infrastructures. With a focus on secure, resilient, and highly available cloud networking, Yeshwanth oversees the ongoing development and optimization of this architecture.

Contact:
- Email: yeshwanth.ra61@gmail.com
- GitHub: Yeshwanth-Reddy-Aleti