...
#### 1. Clone the repo
    git clone https://github.com/aleti-yeshwanth/three-tier-architecture && cd three-tier-architecture
...
#### 2. Verify the app.py webapp is running via Docker 
...
## Maintainer
This project is maintained by Yeshwanth Reddy Aleti, a Network Engineer with over 4 years of experience in designing and supporting enterprise network infrastructures. His expertise includes routing and switching, network security, and cloud networking, with a focus on delivering secure and resilient infrastructure services.

For inquiries or contributions, please reach out via:
- Email: yeshwanth.ra61@gmail.com
- GitHub: https://github.com/aleti-yeshwanth
- LinkedIn: https://www.linkedin.com/in/yeshwanth-reddy-aleti