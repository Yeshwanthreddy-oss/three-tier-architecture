...
# Prerequisites
* An AWS Account with an IAM user capable of creating resources - AdministratorAccess
...
#### 1. Clone the repo
    git clone https://github.com/yeshwanth-aleti/three-tier-architecture && cd three-tier-architecture
...
Check the infrastructure deployment status by entering the following terraform command:
...
NOTE: You may want to output terraform show to a .txt file for easier viewing i.e. terraform show > tf_infrastructure.txt
...
#### 2. Verify the application webapp is running via Docker 
...
## Maintainer
This project is maintained by Yeshwanth Reddy Aleti, a Network Engineer with over 4 years of experience in designing and implementing enterprise network infrastructures. His expertise includes cloud networking, network security, and infrastructure automation using Python, PowerShell, and Bash.

Email: yeshwanth.ra61@gmail.com
GitHub: yeshwanth-aleti
LinkedIn: yeshwanth-reddy-aleti