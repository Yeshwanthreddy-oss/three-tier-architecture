...
#### 2. Verify yeshwanth-aleti/app.py webapp is running via Docker 
...
# About the Developer
Yeshwanth Reddy Aleti is a Network Engineer with over 4 years of experience designing and implementing enterprise network infrastructures. Specializing in cloud networking, security, and infrastructure management, Yeshwanth focuses on delivering secure and resilient network services across global enterprise environments.

Email: yeshwanth.ra61@gmail.com
Skills: Python, PowerShell, Bash, AWS, Terraform